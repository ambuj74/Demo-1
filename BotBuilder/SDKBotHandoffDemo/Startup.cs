...
namespace SDKBotHandoffDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // ServiceNow Handoff
            services.AddSingleton<ServiceNowHandoffMiddleware>();
            ...
            services.AddSingleton<IBotFrameworkHttpAdapter>(sp =>
            {
                ...
                var logger = sp.GetService<ILogger<BotFrameworkHttpAdapter>>();
                var serviceNowMiddleware = sp.GetService<ServiceNowHandoffMiddleware>();
                var adapter = new AdapterWithErrorHandler(configuration, logger);
                adapter.Use(serviceNowMiddleware);
                return adapter;
            });

            //services.AddSingleton<BotAdapter, BotFrameworkHttpAdapter>();
        }
